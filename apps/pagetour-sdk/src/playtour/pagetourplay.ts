      ...
      if (stepCount === 0) {
        ...
        if (this.tour.steps[stepCount].headerText !== undefined && this.tour.steps[stepCount].headerText !== '') {
          if (this.validImageURL(this.tour.steps[stepCount].headerText)) {
            ...
            let announcementHeader = document.getElementById('announcementheader');
            announcementHeader.style.backgroundImage =  `url(${this.tour.steps[stepCount].headerText})`;
            announcementHeader.style.objectFit = "contain"
